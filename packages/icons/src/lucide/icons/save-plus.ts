...
export const iconNode: IconNode = [
  ["path", { d: "M12.5 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h10.2a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V12", key: "bhibzn" }],
...
const SavePlus = createLucideIcon("save-plus", iconNode);
